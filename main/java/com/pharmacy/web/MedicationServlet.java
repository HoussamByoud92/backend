...
public class MedicationServlet extends main.java.com.pharmacy.web.BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (pathInfo == null || pathInfo.equals("/")) {
            ...
            medication.setExpirationDate(java.time.LocalDate.parse(request.getParameter("expirationDate")));
